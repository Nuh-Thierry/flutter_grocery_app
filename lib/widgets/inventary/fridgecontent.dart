...
class InventaryContent extends StatefulWidget {
  ...
  @override
  State<InventaryContent> createState() => _InventaryContentState();
}

class _InventaryContentState extends State<InventaryContent> {
