...
class PantryContent1 extends StatefulWidget {
  ...
  @override
  State<PantryContent1> createState() => _PantryContent1State();
}

class _PantryContent1State extends State<PantryContent1> {
  List<InventoryItem> items = [];
  List<TextEditingController> textFieldControllers = [];
  int currentIndex = 0;
  PageController? _controller;

  List<InventoryItem> modifiedItems = [];
  ...
  void initState() {
    super.initState();
    inventoryStream =
        FirebaseFirestore.instance.collection('Pantry').snapshots();
  }
