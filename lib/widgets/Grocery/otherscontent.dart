...
class OthersContent1 extends StatefulWidget {
  ...
  @override
  State<OthersContent1> createState() => _OthersContent1State();
}

class _OthersContent1State extends State<OthersContent1> {
